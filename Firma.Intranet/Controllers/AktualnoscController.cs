...
namespace Firma.Intranet.Controllers
{
    public class AktualnoscController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAktualnosci,LinkTytul,Tytuł,Tresc,Pozycja")] Aktualnosc aktualnosc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAktualnosci,LinkTytul,Tytuł,Tresc,Pozycja")] Aktualnosc aktualnosc)
        {
